...
<li class="menu-item"><a href="myreservations.php" class="menu-link active"><img src="../asset/reservations.png" class="menu-icon">My Reservations</a></li>
<li class="menu-item"><a href="../my-account/my-account.php" class="menu-link"><img src="../asset/profile.png" class="menu-icon">My Account</a></li>
</ul>
</div>
...
<button class="btn btn-sm btn-outline-secondary" disabled>View Reason</button>
...
<button
    type="button"
    class="btn btn-sm btn-warning view-reason-btn"
